...
int main(){
  ...
  cout<<"Writing intermediate_File to 'intermediate_"<<fileName<<"'"<<endl;
  cout<<"Writing error_File to 'error_"<<fileName<<"'"<<endl;
  pass1();
...
writestring="" ;
  ...
  cout<<"Writing objectt_File to 'object_"<<fileName<<"'"<<endl;
  cout<<"Writing listing_File to 'listing_"<<fileName<<"'"<<endl;
  pass2();
